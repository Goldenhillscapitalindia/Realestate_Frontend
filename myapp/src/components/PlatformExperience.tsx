...
const PlatformExperience = () => {
  ...
  return (
    <section id="platform-experience" className="section-padding section-dark section-dark-grid" style={{ background: "linear-gradient(180deg, #0b1a3a 0%, #0e1d35 50%, #0b1a3a 100%)" }}>
